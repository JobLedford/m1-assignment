...
var openLink =
  "<a id='infoLink' onclick = 'closeInfoBox()'> Click This to Close";
var closeLink = "</a>";
...
//3.1. Create a loop to create 4 Caption & Paragraph, then store in "boxList"
for (var i = 0; i < 4; i++) {
  headNames.push("doge" + (i + 1));
  paraContent.push(
    "This is " + headNames[i] + ". He is a male dog that is " + (i + 1) + " years old."
  );
  box =
    openSpan +
    openHead +
...
boxinbox.addEventListener(click, closeInfoBox);
